...
\def\FormatName#1{%
          ...
          \author{\textbf{PI: Kathryn Huff}\\%
                  ...
                  \and
           \textbf{Co-PI: Neal Davis}\\University of Illinois at Urbana--Champaign
                  \and
           Paul Wilson\\
          ...
          \rhead{\textcolor{gray}{Open-Source Collaborative Curriculum\\}}
          ...
          % TODO:  comment on how SWC has successfully surmounted the other challenges noted above
          ...
          developing a collaborative computational curriculum for some time 
          \cite{davis_university_2016}. Since he currently
          teaches large-scale computational curriculum at UIUC 
...
\fi
          ...
          and UIUC Co-PI Davis, external collaborating professors Wilson, 
          ...
          the first workshop include learning objectives\cite{bloom_bloom_1984}, a concept 
          map\cite{novak_concept_1990}, an outline of fine-grained lesson modules, and a 
          graph describing dependencies among lessons. Additionally, concrete logistics 
...
\hline
          ...
          Between workshops, we will commence work on developing the fine-grained lesson
          modules. These lessons will be submitted by pull request to the main 
